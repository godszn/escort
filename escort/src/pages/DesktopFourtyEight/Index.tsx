                    ...
                    <div className="flex flex-col gap-6 items-start justify-start w-[98%] md:w-full">
                      <div className="bg-white-A700 border border-black-900 border-solid flex flex-col items-center justify-start p-[27px] sm:px-5 rounded-[15px] shadow-bs7 w-full">
                        <div className="flex flex-col items-start justify-start mb-[37px] w-full">
                          ...
                          <div className="bg-white-A700 border border-black-900 border-solid h-[120px] mt-11 rounded-lg shadow-bs1 w-full">
                            <textarea className="w-full h-full" style={{border: 'transparent', borderRadius: '.5rem'}}></textarea>
                          </div>
                          <div className="border border-black-900 border-solid h-[54px] mt-[41px] rounded-lg shadow-bs1 w-full">
                            <textarea  className="w-full h-full" style={{border: 'transparent', borderRadius: '.5rem'}}>
                  ...
                  <div className="bg-white-A700 flex flex-col items-center justify-start mb-3 p-2 rounded-[5px] w-full">
                    <div className="flex flex-col gap-[15px] items-start justify-start my-[11px] w-full">
                      <div className="flex flex-col items-center justify-start ml-3 md:ml-[0] w-[98%] md:w-full">
                        ...
                        <div className="bg-white-A700 relative flex flex-col items-end justify-end outline outline-gray-800_04 p-1.5 rounded-[5px] w-full">
                          <Img
                            className="h-[19px] mr-1.5 mt-[5px]"
                            src="images/img_eye_gray_700_05.svg"
                            alt="eye"
                          />
                          <input style={{border: 'transparent' , height: '30px' , left: '1%' , top: '8%' , width: '50%'}} type="text" className="absolute" />
                        </div>
                      </div>
                      <List
                      ...
                      >
                        <div className="flex flex-1 flex-col items-center justify-start px-3 w-full">
                          ...
                          <div className="bg-white-A700 flex relative flex-col items-end justify-start outline outline-gray-800_04 p-2 rounded-[5px] w-full">
                            <Img
                        ...
                        <div className="flex flex-1 flex-col items-center justify-start w-full">
                          ...
                          <div className="bg-white-A700 flex relative flex-col items-end justify-start outline outline-gray-800_04 p-2 rounded-[5px] w-[95%] md:w-full">
                            <Img
                ...
                <div className="flex flex-col gap-[27px] items-start justify-start mb-[35px] mt-[27px] w-full">
                  ...
                  <div className="font-montserrat md:gap-5 gap-[22px] grid md:grid-cols-1 grid-cols-2 justify-center min-h-[auto] w-full">
                    <div className="md:h-[50px] h-[59px] relative w-full">
                      ...
                      <Text
                        className="absolute left-[4%] top-[23%] text-[13px] text-gray-700_04 top-[0]"
                        size="txtMontserratRegular13"
                      >
                        Ethnicity
                      </Text>
                      <input type="text" className="absolute p-[0]" style={{border: 'transparent', height: '27px', fontSize: 'small' , top: '30px' , left: '4%'}} />
                    </div>
                    <div className="md:h-[50px] h-[59px] relative w-full">
                      <div className="absolute bg-white-A700 border border-gray-900_04 border-solid bottom-[0] flex flex-col inset-x-[0] items-end justify-start mx-auto rounded-lg shadow-bs1 w-full">
                        <Img
                    ...
                    <div className="h-[60px] mt-[6px] relative w-full">
                      <Text
                        className="mb-[-7.21px] text-[13px] absolute left-[4%] top-[10%] text-gray-700_04 z-[1]"
                        size="txtMontserratRegular13"
                      >
                        Hair color
                      </Text>
                      <input type="text" className="absolute p-[0]" style={{border: 'transparent', height: '27px', fontSize: 'small' , top: '33%' , left: '4%'}} />
              ...
              <div className="flex flex-col gap-[25px] items-start justify-start mb-[35px] mt-7 w-full">
                ...
                <div className="font-montserrat md:gap-5 gap-[22px] grid md:grid-cols-1 grid-cols-2 justify-center min-h-[auto] w-full">
                  <div className="h-[62px] relative w-full">
                    <Text
                      className="bg-white-A700 h-[17px] justify-center mb-[-7px] absolute top-[5px] ml-[11px] pl-[9px] text-[13px] text-gray-700_04 w-[86px] z-[1]"
                      size="txtMontserratRegular13"
                    >
                      Character
                    </Text>
                    <input type="text" className="absolute p-[0] w-[60%] top-[22px] left-[2%]" style={{border: 'transparent', height: '27px', fontSize: 'small' , left: '4%'}} />
                  ...
                  <div className="h-[62px] relative w-full">
                    <Text
                      className="bg-white-A700 h-[17px] justify-center absolute top-[5px] mb-[-7px] ml-[11px] pl-[9px] text-[13px] text-gray-700_04 w-[78px] z-[1]"
                      size="txtMontserratRegular13"
                    >
                      Children
                    </Text>
                  ...
                  <div className="h-[62px] relative w-full">
                    <Text
                      className="bg-white-A700 h-[17px] justify-center mb-[-7px] ml-[11px] absolute top-[5px] pr-3 text-[13px] text-gray-700_04 w-[70px] z-[1]"
                      size="txtMontserratRegular13"
                    >
                      Friends
                    </Text>
                  ...
                  <div className="h-[62px] relative w-full">
                    <Text
                      className="bg-white-A700 h-[17px] justify-center mb-[-7px] ml-[11px] absolute top-[5px] text-[13px] text-gray-700_04 w-[50px] z-[1]"
                      size="txtMontserratRegular13"
                    >
                      Pets
                    </Text>
