      ...
      <div className="relative">
        ...
        >
          <div className="w-full flex gap-5 ">
            <div className="side-nav p-2 w-[268px] h-fit flex flex-col items-center ml-[1.5rem]" style={{ backgroundColor: 'white', boxShadow: '1px 2px 11px lightsteelblue', borderRadius: '.2rem' }} >
