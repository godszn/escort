...
import escortRequest from 'assets/images/escortRequest.png'
    ...
    return (
        <div>
            <div className=' bg-cover bg-no-repeat ' style={{
                ...
                <nav className='flex justify-end' style={{ backgroundColor: 'white' }}>
                    <div className="flex md:flex-1 sm:flex-col flex-row sm:gap-5 items-center Dashboard-left-nav justify-end w-[38%] md:w-full">
                ...
                <div className='flex items-center justify-start'>
                    <section className='flex w-[85%] justify-between'>
                        <div className="side-nav items-center p-2 w-[268px] flex flex-col ml-[1.5rem]" style={{ backgroundColor: 'white', boxShadow: '1px 2px 11px lightsteelblue', borderRadius: '.2rem' }} >
                            ...
                            <section className='mt-4 w-[100%]'>
                                <ul className='dashboard-lists'>
                                    ...
                                    <section style={{ borderBottom: '1px solid black' , borderTop: '1px solid black' }} >
                                    <li className='justify-between'>
                                       <section className='flex items-center'>
                                       <img src={user} alt=""/>
                                        Profile
                                       </section>
                                        <img onClick={toggle} style={ArrowStyle} src={drop} alt="" />
                                    </li>
                                    {isDropdown && <div className='text-sm'>
                                        <li className='ml-[1.5rem]' style={{borderRadius: '.5rem'}} onClick={editImages}>
                                        Add Images
                                    </li>
                                    <li className='ml-[1.5rem]' style={{borderRadius: '.5rem'}} onClick={editVideos}>
                                        Add videos
                                    </li>
                                        </div>}
                                    <li onClick={Gallery}>
                        ...
                        <div className="dashboard-wrapper w-[65%]">
                            <h1>Dashboard</h1>
                            <section className='grid-cols-2 dahs grid gap-[20px] w-[100%]'>
                                <div className='items-center flex p-[.8rem]' style={{ borderLeft: '2px solid red', backgroundColor: '#FD2C7926', borderRadius: '.3rem' }}>
                                    <img src={heart} style={{ height: '30px' }} alt="" />
                                    <section className='ml-2'>
                                        <h1 style={{ fontSize: '24px', lineHeight: '1' }}>
                                            49
                                        </h1>
                                        <p>Removing interests</p>
                                    </section>
                                </div>
                                <div className=' flex items-center p-[.8rem]' style={{ borderLeft: '2px solid orange', backgroundColor: '#FD2C7926 ', borderRadius: '.3rem' }}>
                                    <img src={call} alt="" style={{ height: '30px' }} />
                                    <section className='ml-2'>
                                        <h1>
                                            20
                                        </h1>
                                ...
                                <div className=' flex items-center p-[.8rem]' style={{ borderLeft: '2px solid green', backgroundColor: '#DCFCE7', borderRadius: '.3rem' }}>
                                    <img src={upload} alt="" style={{ height: '30px' }} />
                                    <section className='ml-2'>
                                        <h1>
                                            5
                                        </h1>
                                ...
                                <div className=' flex items-center p-[.8rem]' style={{ borderLeft: '2px solid green', backgroundColor: '#FD2C7926', borderRadius: '.3rem' }}>
                                    <img src={heart1} alt="" style={{ height: '30px' }} />
                                    <section className='ml-2'>
                                        <h1>
                                            1
                                        </h1>
                                ...
                                <div className=' flex items-center p-[.8rem]' style={{ borderLeft: '2px solid orange', backgroundColor: '#FFEFCE ', borderRadius: '.3rem' }}>
                                    <img src={heart2} alt="" style={{ height: '30px' }} />
                                    <section className='ml-2'>
                                        <h1>
                                            0
                                        </h1>
                                        <p>Interests requests</p>
                                    </section>
                                </div>
                            </section>
                            <section className='p-4 mt-[2rem]' style={{backgroundColor: 'white' , borderRadius: '.5rem' , boxShadow: '1px 2px 11px lightgrey'}}>
                                <h1 className='p-4' style={{borderBottom: '1px solid grey' , fontSize: '19px' , fontWeight: '600'}}>
                                    Current Package
                                </h1>
                                <div>
                                    <h1 className='p-4' style={{fontSize: '19px' , fontWeight: '600'}}>
                                        Free
                                    </h1>
                                    <section className='p-2 ml-4' style={{ color : '#999999'}}>
                                        <p>
                                            10 Exscort Advert post
                                        </p>
                                        <p>
                                            20 Contact View
                                        </p>
                                    ...
                                    <section style={{ color : '#999999'}} >
                                        <p>
                                            Package expiry date : 26 Dec, 2023
                                        </p>
                                        <button className='p-2 mt-2' style={{ backgroundColor: '#FD00B3', color : 'white' , borderRadius: '.5rem'}} >
                                            Update Packages
                                        </button>
                                    </section>
                                </div>
