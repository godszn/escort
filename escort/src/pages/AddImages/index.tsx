    ...
    <div>
      ...
      <div className='main bg-cover bg-no-repeat ' style={{
        ...
        <div className='flex justify-between pt-[4rem]'>
          <section>
            <div className="side-nav p-2 w-[268px] flex flex-col items-center ml-[1.5rem]" style={{ backgroundColor: 'white', boxShadow: '1px 2px 11px lightsteelblue', borderRadius: '.2rem' }} >
              ...
              <section className='mt-4 w-[100%]'>
                <ul className='dashboard-lists'>
                  ...
                  {isDropdown && <div className='text-sm'>
                    <li className='active1 ml-[1.5rem]' style={{ borderRadius: '.5rem' }} >
                      Add Images
                    </li>
          ...
          <section className='w-[65%] p-[2rem] mr-[3rem] flex flex-col' style={{ boxShadow: '1px 2px 11px lightgrey', backgroundColor: 'white', borderRadius: '.8rem' }}>
            <h1 style={{ fontSize: '23px', fontWeight: '500', marginTop: '1.5rem', marginBottom: '1.5rem' }}>
              Gallery
            </h1>
            <div className=' flex items-center' style={{ height: '160px', border: '2px solid darkgrey', borderRadius: '.5rem' }}>
              <p style={{ color: 'rgb(183 178 178)' }} className='text-center w-full'>
                Drag & Drop files here or click to browse. Select maximum 20 images
              </p>
            </div>
            <button style={{ padding: '.5rem', backgroundColor: 'deeppink', marginTop: '1rem', borderRadius: '.5rem', color: 'white' }}>
              Submit
            </button>
            <button style={{ padding: '.5rem', backgroundColor: 'deeppink', marginTop: '.5rem', borderRadius: '.5rem', color: 'white' }}>
